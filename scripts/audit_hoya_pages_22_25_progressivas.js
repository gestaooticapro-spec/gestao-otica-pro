...
if (!versionId) {
  console.error('Uso: node scripts/audit_hoya_pages_22_25_progressivas.js --version-id=UUID')
  process.exit(1)
}
...
async function main() {
  ...
  console.log('AUDIT_HOYA_P22_P25_PROGRESSIVAS')
  console.log(JSON.stringify({ summary, rows }, null, 2))
}

main().catch((err) => {
  console.error('Erro audit hoya p22-p25:', err)
  process.exit(1)
})
