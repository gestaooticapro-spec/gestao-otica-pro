-- Corrige a referencia ambigua a store_id na funcao de reemissao.
-- A coluna de retorno store_id da funcao e a coluna da tabela tinham o mesmo
-- nome; o alias torna explicita a coluna usada no UPDATE.
