...
export const PENDING_RELEASE_CHANGES: readonly string[] = [
  ...
  'O MODO EXPERIMENTAL DO WHATSAPP PASSOU A PEDIR UMA UNICA CORRECAO A IA QUANDO UMA RESPOSTA ESTRUTURADA VEM EM FORMATO INVALIDO, ANTES DE USAR O FALLBACK SEGURO.',
