...
export const PENDING_RELEASE_CHANGES: readonly string[] = [
  ...
  'O HANDOFF DO WHATSAPP PASSOU A MANTER O CONTEXTO PENDENTE ATE A PRIMEIRA RESPOSTA HUMANA; DEPOIS DISSO, CADA MENSAGEM DA EQUIPE RENOVA UMA PAUSA DE UMA HORA.',
