    ...
    <div className="p-6 max-w-7xl mx-auto min-h-[calc(100vh-64px)] flex flex-col">
      ...
      {!success || !itens || itens.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center text-gray-400 border-2 border-dashed border-gray-200 rounded-3xl m-4">
          ...
          <p className="text-lg font-bold text-gray-500">A gaveta está vazia!</p>
          <p className="text-sm mt-1">Todos os óculos prontos já foram entregues.</p>
          <p className="text-xs text-amber-600/70 mt-4 bg-amber-50 px-4 py-2 rounded-lg border border-amber-100 max-w-sm text-center">
