                                                                                ...
                                                                                <td className="px-4 py-2 text-right whitespace-nowrap">
                                                                                    {isPago ? (
                                                                                        ...
                                                                                        <button
                                                                                            ...
                                                                                            className="inline-flex shrink-0 items-center gap-1.5 px-2.5 py-1.5 rounded-lg border border-emerald-500/20 bg-emerald-500/10 text-emerald-300 hover:bg-emerald-500 hover:text-white transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                                                                                        ...
                                                                                        {p.reversible_receipt_operation ? (
                                                                                            <button
                                                                                                ...
                                                                                                className="inline-flex shrink-0 items-center gap-1.5 rounded-lg border border-rose-500/20 bg-rose-500/10 px-2.5 py-1.5 text-rose-300 transition-colors hover:bg-rose-500/20"
