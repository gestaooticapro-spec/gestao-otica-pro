  ...
  useEffect(() => {
    ...
    const read = async () => {
      try {
        ...
        const body = await response.json() as { charge: DisplayCharge | null; queuedCount?: number }
        if (!active) return
