                ...
                {headerGroup.headers.map(header => (
                  ...
                  >
                    ...
                    <div
                      ...
                      className={`absolute right-0 top-0 h-full w-[4px] cursor-col-resize select-none touch-none hover:bg-blue-400 ${header.column.getIsResizing() ? 'bg-blue-600 opacity-100' : 'opacity-0 group-hover:opacity-100'
                        }`}
                    />
                  </th>
                ))}
