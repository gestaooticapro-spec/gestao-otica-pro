          ...
          <div className="space-y-5 p-5">
            {charge ? (
              <>
                ...
                {charge.status === 'PAID' && charge.settlementStatus !== 'COMPLETED' ? <p className="rounded-xl border border-amber-500/20 bg-amber-500/10 p-3 text-xs text-amber-200">O pagamento foi confirmado no Sicredi, mas a baixa ainda não foi concluída. Use “Conferir pagamento” para reprocessar com segurança.</p> : null}
              </>
            ) : (
              <>
