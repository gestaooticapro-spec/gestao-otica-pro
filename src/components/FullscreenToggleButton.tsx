...
export default function FullscreenToggleButton({
  ...
  return (
    <button
      ...
      className={`fixed right-4 top-4 z-[80] flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-slate-950/70 text-white/70 shadow-xl backdrop-blur-md transition-all hover:border-white/20 hover:bg-slate-900/85 hover:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500/70 ${className}`}
    >
