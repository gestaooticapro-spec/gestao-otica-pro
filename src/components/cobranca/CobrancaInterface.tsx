        ...
        <div className="relative flex flex-col h-full bg-slate-950 overflow-hidden font-sans">
            ...
            <div className="relative z-10 bg-white/5 backdrop-blur-xl border-b border-white/10 px-6 py-3 flex items-center justify-between flex-shrink-0 shadow-2xl h-14">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-lg font-black text-white tracking-tight uppercase">Central de Cobrança</h1>
                        <p className="text-[10px] text-red-400 font-black uppercase tracking-[0.2em] opacity-80">
                            Gerencie inadimplência e histórico
                        </p>
                    </div>
                </div>
            ...
            {/* Área de Trabalho */}
            <div className="relative z-10 flex-1 overflow-hidden p-4 lg:p-6 min-h-0">
                <div className="grid grid-cols-12 gap-6 h-full overflow-hidden">

                    {/* COLUNA ESQUERDA: LISTA DE CLIENTES */}
                    <div className="col-span-12 lg:col-span-4 flex flex-col gap-4 h-full min-h-0 overflow-hidden">
